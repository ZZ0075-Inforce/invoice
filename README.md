...
- **`query.html` 查詢頁**——關鍵字搜尋（店家／品名／發票號碼）＋月份、分類、
  ...
  訂閱型消費（同店家、金額相近、月級以上週期、至少 3 次）；「價格追蹤」找出
  同一家店的同一個品項有沒有悄悄漲價（見下）。
...
**價格追蹤（查詢頁第四個視圖）**：同一家店、品名完全相同、至少在兩個不同
日子買過的品項就會被追蹤；上半是**漲價清單**——最近一次單價高於先前價格的
中位數 5% 以上才上榜，點列展開看單價時間線（價格點三個以上才畫折線，兩個
點的折線只是一條直線）；下半是全部可追蹤品項，可搜尋。**不跨店比價**：
不同店的同名商品未必是同一件東西。

比的一律是單價（沒有單價才用金額÷數量回推），贈品與折讓這種非正價的列不
採計，同一天同一個品名出現兩種價格的那天也不採計——這兩項各排除了幾筆，
頁面底下會說明。同店同名但價格散布超過 3 倍的（通常是規格不同卻共用一個
品名）不會進漲價清單，但仍列在全表，排除數就標在清單旁。久沒再買的不會被
濾掉，只是標記出來。
